...
import { MedicalScan, ScanType, ScanStatus } from '@shared/types/medical';
import './Scans.css';
  ...
  return (
    <div className="scans-page">
      ...
      <nav className="navbar">
        <h1 className="navbar-title">Aethea</h1>
        <div className="navbar-links">
          <Link to="/dashboard" className="navbar-link">Dashboard</Link>
          <Link to="/lab-results" className="navbar-link">Lab Results</Link>
          <Link to="/scans" className="navbar-link active">Medical Scans</Link>
        </div>
      </nav>
