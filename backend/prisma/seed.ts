...
import { PrismaClient, Prisma } from '../src/generated/prisma/client/index.js';
...
const ACCOUNTS = {
  admin:       { id: '1c8e4f56-8af4-452a-ae6f-7b20a6d3d9b7', email: 'admin@aethea.me' },
  patient:     { id: 'ae0b9899-7075-4b2d-bfaa-93e3aed947bc', email: 'pat@aethea.me' },
  doctor:      { id: 'db2417ae-914d-468f-9db1-0503fb556b24', email: 'doc@aethea.me' },
  pharmacist:  { id: 'c58b6c74-f6d3-4fe8-90fd-ed1ad15840c9', email: 'farm@aethea.me' },
};
    ...
    data: [
      {
        ...
        images: [
          {
            id: 'mri-1',
            url: '/mri_placeholder.webp',
            thumbnail: '/mri_placeholder.webp',
      ...
      },
      {
        ...
        images: [
          {
            id: 'ct-1',
            url: '/ct_placeholder.webp',
            thumbnail: '/ct_placeholder.webp',
            caption: 'Axial View'
          }
        ]
      },
